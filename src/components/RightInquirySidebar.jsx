...
import { X, MessageSquare, Loader2, CheckCircle, User, Mail, Phone, Send } from "lucide-react";
        ...
        {!isOpen ? (
          ...
          >
            ...
            <div className="p-4 border-b border-platinum/60 flex items-center justify-between">
              <div>
                <h3 className="font-serif text-base font-bold text-charcoal tracking-tight">Enquiry Form</h3>
                <p className="text-[9px] text-charcoal/60 mt-0.5 font-sans uppercase tracking-widest font-semibold">Direct Developer Channel</p>
              </div>
              <button
            ...
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
              {isSuccess ? (
                <div className="h-full flex flex-col items-center justify-center text-center px-2 py-8 animate-fade-in">
                  ...
                  <h4 className="font-serif text-base font-bold text-charcoal mb-2">Request Transmitted</h4>
                  <p className="text-xs text-charcoal/70 leading-relaxed max-w-[220px]">
                    Your VIP concierge ticket has been locked. A direct developer representative will contact you in 15 minutes.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-[9px] font-bold uppercase tracking-widest text-charcoal/70 flex items-center gap-1">
                      ...
                      <span>Full Name <span className="text-luxury-red">*</span></span>
                    </label>
                    <input
                      type="text"
                      name="name"
                    ...
                    />
                    {errors.name && <span className="text-[9px] font-medium text-luxury-red">{errors.name}</span>}
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-[9px] font-bold uppercase tracking-widest text-charcoal/70 flex items-center gap-1">
                      ...
                      <span>Email ID <span className="text-luxury-red">*</span></span>
                    </label>
                    <input
                      type="email"
                      name="email"
                    ...
                    />
                    {errors.email && <span className="text-[9px] font-medium text-luxury-red">{errors.email}</span>}
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-[9px] font-bold uppercase tracking-widest text-charcoal/70 flex items-center gap-1">
                      ...
                      <span>Phone Number <span className="text-luxury-red">*</span></span>
                    </label>
                    <input
                      type="tel"
                      name="phone"
                    ...
                    />
                    {errors.phone && <span className="text-[9px] font-medium text-luxury-red">{errors.phone}</span>}
                  </div>
